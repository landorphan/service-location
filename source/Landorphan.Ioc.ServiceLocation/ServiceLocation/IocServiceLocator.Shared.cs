            ...
            if (CanLog(out var logger, out var loggingUtils))
            {
                ...
                switch (eventId)
                {
                    case IocEventIdCodes.ServiceLocator.ContainerAssemblyCollectionSelfRegistrationInvokedBefore:
                        loggingUtils.LoggingUtilitiesForIocIocServiceLocator.GetMessageContainerAssemblyCollectionSelfRegistrationInvokedBefore(
                    ...
                    case IocEventIdCodes.ServiceLocator.ContainerAssemblyCollectionSelfRegistrationsInvokedAfter:
                        loggingUtils.LoggingUtilitiesForIocIocServiceLocator.GetMessageContainerAssemblyCollectionSelfRegistrationInvokedAfter(
                            IocContainer.InternalRootContainer,
                            assemblies,
                            out message);
                        break;
