namespace Landorphan.Ioc.Resources
{
    ...
    {
        internal const string AbstractAssemblyRegistrarExceptionDefaultMessageFmt =
        ...
        internal const string IocContainerConfigurationLockedExceptionDefaultMessageFmt =
