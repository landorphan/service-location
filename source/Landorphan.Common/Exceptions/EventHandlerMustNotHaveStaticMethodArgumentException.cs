namespace Landorphan.Common
{
   ...
   /// have static <see cref="Delegate.Method"/> values.
   /// </summary>
   public sealed class EventHandlerMustNotHaveStaticMethodArgumentException : LandorphanArgumentException
   {
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="EventHandlerMustNotHaveStaticMethodArgumentException"/> class with the name of the parameter that caused
      /// this
      /// exception.
      /// </summary>
      /// <param name="message">
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="EventHandlerMustNotHaveStaticMethodArgumentException"/> class with the inner exception that gave rise to
      /// this exception.
      /// </summary>
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="EventHandlerMustNotHaveStaticMethodArgumentException"/> class with a specified error message and the
      /// exception
      ...
      /// <summary>
      /// Initializes an instance of the <see cref="EventHandlerMustNotHaveStaticMethodArgumentException"/> class with a specified error message and the name
      /// of the
