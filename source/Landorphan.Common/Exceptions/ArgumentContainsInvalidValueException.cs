namespace Landorphan.Common
{
   ...
   /// <summary>
   /// The exception that is thrown when a collection containing an invalid value is passed to a method that rejects the collection as a
   /// valid argument.
   /// </summary>
   public sealed class ArgumentContainsInvalidValueException : LandorphanArgumentException
   {
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="ArgumentContainsNullException"/> class with the name of the parameter that gave
      /// rise to this exception.
      /// </summary>
      /// <param name="message">
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="ArgumentContainsNullException"/> class with a specified error message and the
      /// exception gave rise to this exception.
      /// </summary>
      /// <param name="message">
      /// The error message that explains the reason for this exception.
      /// </param>
