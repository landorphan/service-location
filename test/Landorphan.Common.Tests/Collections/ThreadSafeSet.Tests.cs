namespace Landorphan.Common.Tests.Collections
{
   ...
   public static class ThreadSafeSet_Tests
   {
      [TestClass]
      public class When_I_create_a_ThreadSafeSet : DisposableArrangeActAssert
      {
         private readonly ThreadSafeSet<Int32> target = new ThreadSafeSet<Int32>();
      ...
      [TestClass]
      public class When_I_create_a_ThreadSafeSet_from_a_collection : TestBase
      {
         [TestMethod]
         [TestCategory(TestTiming.CheckIn)]
         public void And_collection_contains_null_values_It_should_contain_only_the_distinct_non_null_values()
         {
            ...
            var target = new ThreadSafeSet<Object>(original);
         ...
         {
            var target = new ThreadSafeSet<Int32>((IEnumerable<Int32>)null);
            target.IsEmpty.Should().BeTrue();
         }
         ...
         public void It_should_contain_only_the_distinct_values()
         {
            ...
            var target = new ThreadSafeSet<Int32>(original);
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_call_Add : TestBase
      {
         [TestMethod]
         [TestCategory(TestTiming.CheckIn)]
         public void It_should_contain_only_the_distinct_values()
         {
            ...
            var target = new ThreadSafeSet<Int32>();
         ...
         {
            var target = new ThreadSafeSet<Object>();
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_call_AddRange : TestBase
      {
         [TestMethod]
         [TestCategory(TestTiming.CheckIn)]
         public void And_source_contains_a_null_It_should_contain_the_distinct_values()
         {
            ...
            var target = new ThreadSafeSet<Object> {obj, new Object()};
         ...
         {
            var originalValues = new[] {3, 2, 1, 0, 0, 2, 4};
            var target = new ThreadSafeSet<Int32>(originalValues);
            var was = target.Count;
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_call_Clear : TestBase
      {
         [TestMethod]
         [TestCategory(TestTiming.CheckIn)]
         public void It_should_be_empty()
         {
            var originalValues = new[] {3, 2, 1, 0, 4};
            var target = new ThreadSafeSet<Int32>();
            target.AddRange(originalValues);
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_call_Contains : TestBase
      {
         [TestMethod]
         [TestCategory(TestTiming.CheckIn)]
         public void And_Item_is_null_it_should_return_false()
         {
            var target = new ThreadSafeSet<Object>(new[] {new Object(), null, new Object()});
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_call_MakeReadOnly : ArrangeActAssert
      {
         private ThreadSafeSet<Int32> target;

         protected override void ArrangeMethod()
         {
            var originalValues = new[] {3, 2, 1, 0, 4};
            target = new ThreadSafeSet<Int32>(originalValues);
         }
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_call_Remove : TestBase
      {
         [TestMethod]
         [TestCategory(TestTiming.CheckIn)]
         public void And_Item_is_null_It_should_return_false()
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_and_perform_set_operations : DisposableArrangeActAssert
      {
         // ReSharper disable AssignNullToNotNullAttribute

         private ThreadSafeSet<Int32> EmptySet;
         private ThreadSafeSet<Int32> Match;
         private ThreadSafeSet<Int32> NoOverlap;

         // ReSharper disable once CollectionNeverUpdated.Local
         private ThreadSafeSet<Object> ReferencesEmpty;
         private ThreadSafeSet<Object> ReferencesMatch;
         private ThreadSafeSet<Object> ReferencesTarget;
         private ThreadSafeSet<Int32> SomeOverlap;
         private ThreadSafeSet<Int32> Subset;
         private ThreadSafeSet<Int32> Superset;
         private ThreadSafeSet<Int32> Target;

         protected override void ArrangeMethod()
         {
            EmptySet = new ThreadSafeSet<Int32>();
            EmptySet.MakeReadOnly();

            Match = new ThreadSafeSet<Int32>(new[] {3, 4, 5});
            Match.MakeReadOnly();

            NoOverlap = new ThreadSafeSet<Int32>(new[] {0, 1, 2});
            NoOverlap.MakeReadOnly();

            SomeOverlap = new ThreadSafeSet<Int32>(new[] {1, 2, 3});
            SomeOverlap.MakeReadOnly();

            Subset = new ThreadSafeSet<Int32>(new[] {3, 5});
            Subset.MakeReadOnly();

            Superset = new ThreadSafeSet<Int32>(new[] {3, 4, 5, 6});
            Superset.MakeReadOnly();

            Target = new ThreadSafeSet<Int32>(new[] {3, 4, 5});

            ReferencesTarget = new ThreadSafeSet<Object>(new[] {new Object(), new Object(), new Object()});
            ReferencesMatch = new ThreadSafeSet<Object>(ReferencesTarget);
            ReferencesEmpty = new ThreadSafeSet<Object>();
         }
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeSet_with_mutable_values_and_mutate_them_into_a_collision : ArrangeActAssert
      {
