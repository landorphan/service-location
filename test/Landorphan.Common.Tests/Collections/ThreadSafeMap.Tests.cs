namespace Landorphan.Common.Tests.Collections
{
   ...
   public static class ThreadSafeMap_Tests
   {
      [TestClass]
      public class When_I_create_a_configured_ThreadSafeMap : DisposableArrangeActAssert
      {
         ...
         private ThreadSafeMap<Object, String> target;
         ...
         protected override void ArrangeMethod()
         {
            ...
            target = new ThreadSafeMap<Object, String>(expected, expectedKeyComparer, expectedValueComparer);
         }
      ...
      [TestClass]
      public class When_I_create_a_default_ThreadSafeMap : DisposableArrangeActAssert
      {
         private ThreadSafeMap<Int64, Int32> target;

         protected override void ArrangeMethod()
         {
            target = new ThreadSafeMap<Int64, Int32>();
         }
      ...
      [TestClass]
      public class When_I_create_a_ThreadSafeMap_from_a_collection : DisposableArrangeActAssert
      {
         ...
         protected override void ArrangeMethod()
         {
            target = new ThreadSafeMap<Int64, Int32>(expected);
         }
      ...
      [TestClass]
      public class When_I_create_a_ThreadSafeMap_from_a_null_collection : DisposableArrangeActAssert
      {
         private ThreadSafeMap<Int64, Int32> target;

         protected override void ArrangeMethod()
         {
            target = new ThreadSafeMap<Int64, Int32>(null, null, null);
         }
      ...
      [TestClass]
      public class When_I_create_a_ThreadSafeMap_with_specified_comparers : DisposableArrangeActAssert
      {
         private IEqualityComparer<Object> expectedKeyComparer;
         private IEqualityComparer<String> expectedValueComparer;
         private ThreadSafeMap<Object, String> target;
         ...
         protected override void ArrangeMethod()
         {
            ...
            target = new ThreadSafeMap<Object, String>(expectedKeyComparer, expectedValueComparer);
         }
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_assign_by_key : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
         ...
         private readonly ThreadSafeMap<Int64, Int32> target = new ThreadSafeMap<Int64, Int32>();
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_Add : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_Add_with_a_duplicate_key : DisposableArrangeActAssert
      {
         private readonly Guid existingKey = Guid.NewGuid();
         private readonly Guid existingValue = Guid.NewGuid();
         private readonly ThreadSafeMap<Guid, Guid> target = new ThreadSafeMap<Guid, Guid>();
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_Add_with_a_null_key : DisposableArrangeActAssert
      {
         private readonly ThreadSafeMap<String, String> target = new ThreadSafeMap<String, String>();
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_AddOrUpdate : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_Clear : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_ContainsKey : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_ContainsValue : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_Remove : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_ToDictionary : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_call_TryGetValue : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_and_have_the_same_value_assigned_to_more_than_one_key : DisposableArrangeActAssert
      {
         private readonly List<KeyValuePair<Int64, Int32>> expected = new List<KeyValuePair<Int64, Int32>>
         {
            new KeyValuePair<Int64, Int32>(0, 0),
      ...
      [TestClass]
      public class When_I_have_a_ThreadSafeMap_with_mutable_keys_and_mutate_them_into_a_collision : ArrangeActAssert
      {
         private EquatableTestItem keyA;
         private EquatableTestItem keyB;
         private ThreadSafeMap<EquatableTestItem, Int32> target;

         protected override void ArrangeMethod()
         {
            // create a set of unique items
            target = new ThreadSafeMap<EquatableTestItem, Int32>(new EquatableTestItemEqualityComparer(), EqualityComparer<Int32>.Default);
