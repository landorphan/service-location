namespace Landorphan.Ioc.Tests.ServiceLocation.Extensions
{
    ...
    public static class GetRegistrationChain_Tests
    {
        ...
        {
            protected const string nonUniqueName = "Name Shared in multiple containers";
            private const string childContainerName = "Isolated Test Container (Child): IIocContainerResolver.GetRegistrationChain Tests";
            private const string grandParentContainerName = "Isolated Test Container (Grand Parent): IIocContainerResolver.GetRegistrationChain Tests";
            private readonly Guid grandParentContainerUid = Guid.NewGuid();
            private const string parentContainerName = "Isolated Test Container (Parent): IIocContainerResolver.GetRegistrationChain Tests";
            private const string siblingContainerName = "Isolated Test Container (Sibling): IIocContainerResolver.GetRegistrationChain Tests";
            ...
            protected override void ArrangeMethod()
            {
                ...
                TestHelp.DoNothing(parentContainerUid);
                ...
                TestHelp.DoNothing(childContainerUid);
                ...
                TestHelp.DoNothing(siblingContainerUid);
