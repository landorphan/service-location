namespace Landorphan.Ioc.Tests.ServiceLocation.Extensions
{
    ...
    public static class IsRegistered_Tests
    {
        public abstract class IsolatedContainerChainBase : DisposableArrangeActAssert
        {
            ...
            private const string childContainerName = "Isolated Test Container (Child): IIocContainerResolver.IsRegistered* Tests";
            private const string grandParentContainerName = "Isolated Test Container (Grand Parent): IIocContainerResolver.IsRegistered* Tests";
            private readonly Guid grandParentContainerUid = Guid.NewGuid();
            private const string parentContainerName = "Isolated Test Container (Parent): IIocContainerResolver.IsRegistered* Tests";
            private const string siblingContainerName = "Isolated Test Container (Sibling): IIocContainerResolver.IsRegistered* Tests";
