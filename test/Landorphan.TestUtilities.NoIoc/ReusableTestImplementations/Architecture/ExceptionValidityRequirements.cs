namespace Landorphan.TestUtilities.ReusableTestImplementations
{
   ...
   public abstract class ExceptionValidityRequirements : TestBase
   {
      ...
      /// </summary>
      /// <param name="parameterType">Type of the parameter.
      /// </param>
      /// <param name="defaultValue">The default value to use in the test.
      /// </param>
      /// <returns>
      ...
      ///
      /// 
      /// If your assembly uses exception constructor parameters or fields of another type, override this method and provide a default value for each type used in your assembly that is
      /// not in the list.
      /// 
      /// Code Example
      /// <code>
