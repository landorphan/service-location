namespace Landorphan.Ioc.ServiceLocation.Testability.Tests.Architecture
{
   ...
   public class Ruleset_Tests : RulesetRequirements
   {
      ...
      {
         Rulesets_should_not_have_duplicate_rule_ids_implementation("..\\..\\..\\..\\source\\Landorphan.Ioc.ServiceLocation.Testability\\Landorphan.Ioc.ServiceLocation.Testability.NetStd.ruleset");
      }
